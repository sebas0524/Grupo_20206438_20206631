...
<div class='container'>
  ...
  <div class="pb-5 pt-4 px-3 titlecolor">
    <div class="col-lg-6">
      ...
      <a type="button" class="btn btn-warning" href="<%=request.getContextPath()%>/creaSeleccion">Registrar nueva selección</a>
    </div>
  </div>
  <div class="tabla">
    <table class="table table-dark table-transparent table-hover">
      ...
      <tr>
        ...
        <td>
          <%if(seleccion.getPartidoProximo()!=null){%>
        ...
        <td>
          <a><a type="button" class="btn btn-danger" href="<%=request.getContextPath()%>/BorrarSeleccionServlet?id=<%=seleccion.getIdSeleccion()%>">Borrar Seleccion</a></a>
        </td>
      </tr>
      <%
        }
